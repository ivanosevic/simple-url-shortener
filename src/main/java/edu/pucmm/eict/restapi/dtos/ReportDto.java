...
import edu.pucmm.eict.reports.StringGroupByNum;
...
public class ReportDto {
    ...
    public ReportDto(long clicks, long uniqueClicks, long clicksDuringDay, String topCountryByClicks,
                     List<StringGroupByNum> clicksByBrowser, List<StringGroupByNum> clicksByPlatform,
                     List<StringGroupByNum> clicksByCountry, List<StringGroupByNum> clicksByOS) {
        this.clicks = clicks;
