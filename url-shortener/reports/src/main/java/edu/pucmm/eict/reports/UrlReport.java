...
public class UrlReport {
    ...
    public UrlReport(Long clicks, Long uniqueClicks, Long clicksLast24Hours, ChartData<Long, String> groupedByOs,
                     ChartData<Long, String> groupedByBrowser, ChartData<Long, String> groupedByPlatform,
