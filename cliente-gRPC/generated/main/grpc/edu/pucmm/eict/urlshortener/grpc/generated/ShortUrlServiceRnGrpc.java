package edu.pucmm.eict.urlshortener.grpc.generated;
...
public final class ShortUrlServiceRnGrpc {
  ...
  public static final String SERVICE_NAME = "edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlServiceRn";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.RequestPageShortUrlWithUser,
      edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.PageShortUrlResponse> getGetShortUrlsByUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getShortUrlsByUser",
      requestType = edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.RequestPageShortUrlWithUser.class,
      responseType = edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.PageShortUrlResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.RequestPageShortUrlWithUser,
      edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.PageShortUrlResponse> getGetShortUrlsByUserMethod() {
    io.grpc.MethodDescriptor<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.RequestPageShortUrlWithUser, edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.PageShortUrlResponse> getGetShortUrlsByUserMethod;
      ...
      synchronized (ShortUrlServiceRnGrpc.class) {
        if ((getGetShortUrlsByUserMethod = ShortUrlServiceRnGrpc.getGetShortUrlsByUserMethod) == null) {
          ShortUrlServiceRnGrpc.getGetShortUrlsByUserMethod = getGetShortUrlsByUserMethod =
              io.grpc.MethodDescriptor.<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.RequestPageShortUrlWithUser, edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.PageShortUrlResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getShortUrlsByUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.RequestPageShortUrlWithUser.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.PageShortUrlResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlRequest,
      edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlResponse> getShortUrlMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "shortUrl",
      requestType = edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlRequest.class,
      responseType = edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlRequest,
      edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlResponse> getShortUrlMethod() {
    io.grpc.MethodDescriptor<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlRequest, edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlResponse> getShortUrlMethod;
      ...
      synchronized (ShortUrlServiceRnGrpc.class) {
        if ((getShortUrlMethod = ShortUrlServiceRnGrpc.getShortUrlMethod) == null) {
          ShortUrlServiceRnGrpc.getShortUrlMethod = getShortUrlMethod =
              io.grpc.MethodDescriptor.<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlRequest, edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "shortUrl"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlResponse.getDefaultInstance()))
  ...
  public static abstract class ShortUrlServiceRnImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getShortUrlsByUser(edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.RequestPageShortUrlWithUser request,
        io.grpc.stub.StreamObserver<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.PageShortUrlResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetShortUrlsByUserMethod(), responseObserver);
    }

    /**
     */
    public void shortUrl(edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlRequest request,
        io.grpc.stub.StreamObserver<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.RequestPageShortUrlWithUser,
                edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.PageShortUrlResponse>(
                  this, METHODID_GET_SHORT_URLS_BY_USER)))
          .addMethod(
            getShortUrlMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlRequest,
                edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlResponse>(
  ...
  public static final class ShortUrlServiceRnBlockingStub extends io.grpc.stub.AbstractBlockingStub<ShortUrlServiceRnBlockingStub> {
    ...
    /**
     */
    public edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.PageShortUrlResponse getShortUrlsByUser(edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.RequestPageShortUrlWithUser request) {
    ...
    /**
     */
    public edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlResponse shortUrl(edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ShortUrlServiceRnFutureStub extends io.grpc.stub.AbstractFutureStub<ShortUrlServiceRnFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.PageShortUrlResponse> getShortUrlsByUser(
        edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.RequestPageShortUrlWithUser request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlResponse> shortUrl(
        edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SHORT_URLS_BY_USER:
          serviceImpl.getShortUrlsByUser((edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.RequestPageShortUrlWithUser) request,
              (io.grpc.stub.StreamObserver<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.PageShortUrlResponse>) responseObserver);
          break;
        case METHODID_SHORT_URL:
          serviceImpl.shortUrl((edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlRequest) request,
              (io.grpc.stub.StreamObserver<edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.ShortUrlResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ShortUrlServiceRnBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.pucmm.eict.urlshortener.grpc.generated.ShortUrlProto.getDescriptor();
    }
